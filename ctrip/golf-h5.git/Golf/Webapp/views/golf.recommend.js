 ...
 */
define(['libs', 'c', 'cBasePageView', 'GolfModel', 'GolfStore','CommonStore', 'text!templates/golf.recommend.html','cUtilityCrypt', 'cWidgetFactory','cWidgetGuider', 'cWidgetMember'],
    function (libs, c, pageview, golfModel, golfStore, commonStore, pageTemplate, Crypt, cWidgetFactory ) {
        ...
        var groupView = pageview.extend({
            ...
            weixinShare: function(){
                IWanUtil.app_call_weixin_share(shareData.title,shareData.text,  shareData.linkUrl , null,  shareData.isIOSSystemShare );
            },
            friendsShare: function(){
                IWanUtil.app_call_friends_share(shareData.title,shareData.text,  shareData.linkUrl , null,  shareData.isIOSSystemShare );
            },
            emailShare: function(){
                IWanUtil.app_call_email_share(shareData.title,shareData.text,  shareData.linkUrl , null,  shareData.isIOSSystemShare );
            },
            messageShare: function(){
                IWanUtil.app_call_message_share(shareData.title,shareData.text,  shareData.linkUrl , null,  shareData.isIOSSystemShare );
            },
