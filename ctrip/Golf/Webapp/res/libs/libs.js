...
var Zepto = function () {
    ...
    return C.matches = function (e, t) {
        ...
        if (C.isZ(t))return t;
        var i;
        if (B(t))i = F(t); else if (P(t))i = [H(t) ? n.extend({}, t) : t], t = null; else if (h.test(t))i = C.fragment(t.trim(), RegExp.$1, r), t = null; else {
        ...
        return typeof n == "string" && r === e ? this.length == 0 || this[0].nodeType !== 1 ? e : n == "value" && this[0].nodeName == "INPUT" ? this.val() : !(i = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : i : this.each(function (e) {
            ...
            if (P(n))for (t in n)J(this, t, n[t]); else J(this, n, $(this, r, e, this.getAttribute(n)))
        })
        ...
        }) : r = q(e) + ":" + U(e, n); else for (t in e)!e[t] && e[t] !== 0 ? this.each(function () {
...
window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto), function (e) {
    ...
    function v(e) {
        ...
        return t = !0, n = e.timeStamp, o = e.targetTouches[0].pageX, u = e.targetTouches[0].pageY, e.timeStamp - r < 0 && (r = e.timeStamp), e.timeStamp - r < 200 && e.preventDefault(), !0
    }
