    ...
    tabs: [
        {
            ...
            tabcontent:{
                ...
                selected_den:{
                    "column":[{"id": "address", "name": "城市",data:["上海","北京","广州","成都","武汉"]},{"id": "platform", "name": "平台",data:["Android","IOS","PAD","PCS"]}],// TODO
                ...
                data:{
                    ...
                    address__pv:{
                        "total":4,
                        "column_selected":[{"id": "address", "name": "城市","data":["上海","北京","广州","成都","武汉"],"field":["Android","IOS","PAD","PCS"]}],// TODO
                        "row_selected":[],//用户选择的行
                        "rows": [
                            {
                                "上海": "924",
                    ...
                    address_dateplatform_pv:{ //{"id": "platform", "name": "平台","data":["Android","IOS","PAD","PCS"], "colspan":1},
                        ...
                        "column_selected":[{"id": "address", "name": "城市11","data":["上海","北京","广州","成都","武汉"], "colspan":1,
                            "field": ["上海_Android","北京_Android", "广州_Android","成都_Android","武汉_Android" ]}],// TODO
                        "row_selected":[ {label:"日期", id:"date", data:[2011,2012,2013,2014,2015],"rowspan":4},{label:"平台", id:"date_forms", data:["Android","IOS","PAD","PCS"]}],//用户选择的行
                        "rows": [
                            {
                                "date":"2011",
                                "date_forms": "Android",
