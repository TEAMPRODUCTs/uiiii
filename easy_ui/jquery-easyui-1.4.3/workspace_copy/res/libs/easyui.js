...
var _a1=_a0.options;
var bb=_a0.bb={};
var _a2=$(_9f).addClass("pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");//innerHTML = "<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>"; //easy ui 性能 优化
var tr=_a2.find("tr");
...
if(bb.after){
    console.log("bb.after");//TODO TEST
    bb.after[0].innerHTML = _b3.afterPageText.replace(/{pages}/,_b4);
...
_b7=_b7.replace(/{total}/,_b3.total);
    //TODO test
    console.log('$(_b0).find("div.pagination-info").html(_b7);');
    $(_b0).find("div.pagination-info")[0].innerHTML = _b7;
...
var p=$("<div class=\"tree-node-proxy\"></div>").appendTo("body");
    console.log('"<span class=\"tree-dnd-icon tree-dnd-no\">&nbsp;</span>"+$(_e7).find(".tree-title").html()');
    p.innerHTML = "<span class=\"tree-dnd-icon tree-dnd-no\">&nbsp;</span>"+$(_e7).find(".tree-title").innerHTML;
...
var attr="";
    ...
    var arrattr = [];
if(col.rowspan){
//TODO TEST attr+="rowspan=\""+col.rowspan+"\" ";
    arrattr.push("rowspan=\""+col.rowspan+"\" ");
}
if(col.colspan){
//TODO TEST attr+="colspan=\""+col.colspan+"\" ";
    arrattr.push("colspan=\""+col.colspan+"\" ");
}
//TODO TEST var td=$("<td "+attr+"></td>").appendTo(tr);
    var td=$("<td "+arrattr.join("")+"></td>").appendTo(tr);
if(col.checkbox){
...
td.append("<div class=\"datagrid-cell\"><span></span><span class=\"datagrid-sort-icon\"></span></div>");
    //TODO TEST
    console.log('$("span",td).html(col.title);');
    $("span",td)[0].innerHTML = col.title;
    $("span.datagrid-sort-icon",td)[0].innerHTML = "&nbsp;";
...
return $.data(jq[0],"datagrid")&&$.data(jq[0],"datagrid").data?$.data(jq[0],"datagrid").data.rows:$.data(jq[0],"datagrid");
...
var _735=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
    ...
    //TODO TEST
    console.log('tr.html(this.renderRow.call(this,_72e,_734,_733,_72f,rows[_72f]));');
    //tr.html(this.renderRow.call(this,_72e,_734,_733,_72f,rows[_72f]));
    tr[0].innerHTML =this.renderRow.call(this,_72e,_734,_733,_72f,rows[_72f]);
...
dc.body1.find("div.datagrid-cell-rownumber").each(function(i){
    console.log("$(this).html(i+1);");//TODO
